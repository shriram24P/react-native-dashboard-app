...
const CasteList = ({ navigation }: CasteListScreenProp) => {
  ...
  const handleSearch = (text: string) => {
    const filteredResults = data.filter(
      (item) =>
        item.caste.toLowerCase().startsWith(text.toLowerCase()) &&
        item.caste !== text
    );
    ...
    <>
      ...
      <View style={styles.tableContainer}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.heading, { marginRight: 15 }]}>Caste</Text>
